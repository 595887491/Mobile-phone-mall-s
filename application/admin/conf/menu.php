...
//						array('name' => '手机首页', 'act'=>'mobile_index', 'op'=>'Template'),
	...
	'shop'=>array('name'=>'商城','child'=>array(
				array('name' => '商品','child' => array(
					...
					array('name' => '投票', 'act'=>'index', 'op'=>'Vote'),
			)),
			...
			array('name' => '促销','child' => array(
					...
					array('name' => '专题列表', 'act'=>'goodsTopicList', 'op'=>'Promotion'),
					...
					array('name' => '全球购管理','act'=>'index', 'op'=>'global_purchase'),
                    array('name' => '砍价商品', 'act'=>'bargainList', 'op'=>'Bargain'),
			)),
            ...
            array('name' => '分销2.0','child' => array(
                array('name' => '合伙人列表', 'act'=>'partnerList', 'op'=>'Distribution'),
                array('name' => '合伙人申请', 'act'=>'partnerApply', 'op'=>'Distribution'),
                array('name' => '代理商列表', 'act'=>'agentList', 'op'=>'Distribution'),
                array('name' => '合伙人排行榜', 'act'=>'partnerRank', 'op'=>'Distribution'),
            )),
			...
			array('name' => '统计','child' => array(
                array('name' => '销售统计', 'act'=>'saleReport', 'op'=>'Report'),
                ...
                array('name' => '余额消费统计','act'=>'balance','op'=>'Report'),
			)),
	)),
