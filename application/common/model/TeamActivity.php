...
class TeamActivity extends Model
{
    ...
    public function goods(){
        return $this->hasOne('goods','goods_id','goods_id')->bind(['shop_price','goods_remark','original_img']);
    }
    public function teamFound(){
        return $this->hasMany('teamFound','team_id','team_id')->field('team_id');
    }

    public function teamFollow(){
        return $this->hasMany('teamFollow','team_id','team_id')->field('team_id');
    }
