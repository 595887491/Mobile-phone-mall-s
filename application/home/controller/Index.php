...
class Index extends Base {
    ...
    public function qr_code()
    {
        ...
        $url = urldecode($url);
        $head_pic = input('get.head_pic', '').'?x-oss-process=style/s150x150';
        if (!file_get_contents($head_pic,0,null,0,1)) { //判断图片是否存在
            $head_pic = '';
//            $head_pic = 'http://cdn.cfo2o.com/data/avatar/user_head_default01.png';
        }
        ...
        /* 生成二维码 */
        $qr_code_name = 'user_id_'.$user_id.'.png';
        $qr_code_file = $qr_code_path.$qr_code_name;
        \QRcode::png($url, $qr_code_file, QR_ECLEVEL_M,9);
...
//            $QR = $QR->text('长按识别二维码，领取礼包', "./vendor/topthink/think-captcha/assets/zhttfs/1.ttf", 7, '#5B5B5B', Image::WATER_SOUTH);
        }
