    ...
    public function entry($id = '') {
        ...
        if($this->useZh){ // 中文验证码
            ...
            for ($i = 0; $i<$this->length; $i++) {
                ...
                $codeNX  += mt_rand($this->fontSize*1.2, $this->fontSize*1.6) + 20;
                imagettftext($this->_image, $this->fontSize, mt_rand(-5, 5), $codeNX, $this->fontSize*1.6, $this->_color, $this->fontttf, $code[$i]);
            }
        }
