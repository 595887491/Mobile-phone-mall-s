        ...
        init: function(config){
            ...
            _this.ensureBtn.addEventListener('click',function(){
                ...
                for(var i=0; i<_this.wheel.length; i++){
                    i==_this.wheel.length-1 ? tempValue =_this.getInnerHtml(0) +"-"+_this.getInnerHtml(1)+"-"+_this.getInnerHtml(2) : tempValue += _this.getInnerHtml(i);
                    sessionStorage.setItem('Bargain-province',_this.getInnerHtml(0));
                    sessionStorage.setItem('Bargain-city',_this.getInnerHtml(1));
                    sessionStorage.setItem('Bargain-district',_this.getInnerHtml(2));
                }
