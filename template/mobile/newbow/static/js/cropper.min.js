        ...
        V.load = function(b) {
            ...
            initContainer: function() {
                ...
                c.addClass(u), a.removeClass(u), c.css(this.container = {
                    width: Q(b.width(), U(d.minContainerWidth) || 400),
                    height: Q(b.height(), U(d.minContainerHeight) || 400)
            ...
            setDragMode: function(a) {
                ...
                if (this.ready && !this.disabled) {
                    switch (a) {
                        case "crop":
                            this.options.dragCrop ? (c = !1, b.data("drag", a)) : d = !0;
                            break;
                        case "move":
                            d = !0, b.data("drag", a);
                            break;
